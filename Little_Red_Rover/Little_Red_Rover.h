/*
	Little Red Rover: Built mostly with parts and sensors from Adafruit.
	Copyright (C) 2016 Dale A. Weber <hybotic@hybotics.org>
...
/*
	Program:      	Little Red Rover 1.0, Main navigation, and reactive behaviors, header file
	Date:         	08-Jun-2016
	Version:      	0.1.0 Feather M0 Bluefruit

	Purpose:		    To create a Little Red Rover on steroids
...
*/
#ifndef	__LITTLE_RED_ROVER_H__
#define	__LITTLE_RED_ROVER_H__
...
#define	BUILD_DATE 						      "23-Jul-2016"
#define	BUILD_BOARD						      "Feather M0 Bluefruit"
